...
m_name = 'pretrained7_original_causal_eval_ro_de_simple'
...
DEBERTA_PRETRAINED_MODEL_NAME = \
    os.path.join(PATH, 'deberta_pretraining_2m','deberta-v3-pretrained', 'deberta_checkpoint-epoch-52')

ROBERTA_MODEL_NAME = 'roberta-large'
ROBERTA_PRETRAINED_MODEL_NAME = \
    os.path.join(PATH, 'deberta_pretraining_2m','roberta-pretrained', 'roberta_checkpoint-epoch_7')
...
# model path
#edos_task10/casual_analysis/models/pretrained7_original_causal_eval_ro_de_simple