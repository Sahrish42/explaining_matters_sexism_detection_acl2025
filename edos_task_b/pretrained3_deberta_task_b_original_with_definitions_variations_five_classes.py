...
m_name = 'pretrained3_deberta_task_b_original_with_definitions_variations_five_classes_eval_deberta'
...
print(f"load model from : {os.path.join(PATH, 'deberta_pretraining_2m','deberta-v3-pretrained', 'deberta-checkpoint-3')}")
model = AutoModelForSequenceClassification.from_pretrained(
    os.path.join(PATH, 'deberta_pretraining_2m','deberta-v3-pretrained', 'deberta-checkpoint-3'), num_labels=NUM_CLASSES)
